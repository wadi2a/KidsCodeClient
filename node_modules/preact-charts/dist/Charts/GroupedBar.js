            ...
            h("g", { transform: `translate(${margin.left}, ${margin.top})` },
                ...
                names &&
                    names.map((barName, idx) => h("g", { transform: `translate(0, ${idx * 20})` },
                        h("rect", { x: innerWidth + margin.right - 18, width: 18, height: 15, "stroke-width": '1px', fill: colourScale(barName) }),
                        h("text", { x: innerWidth + margin.right - 24, y: 9, dy: '0.35em', "text-anchor": 'end', fill: 'currentColor' }, legendReference[barName]))))));
    }
    componentDidMount() {
        this.resizeChart();
