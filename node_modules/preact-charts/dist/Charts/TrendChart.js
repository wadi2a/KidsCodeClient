...
export class TrendChart extends Component {
    ...
    render(props, { innerWidth, innerHeight, height, width, isMouseOver, tooltipValues, textAnchor, yDomain }) {
        ...
        return (h("svg", { ref: (svg) => this.chartSVG = svg, class: props.name, height: height, width: width },
            props.axisControl &&
                h("g", { class: axisControl, stroke: props.controlColour, key: 'topControl', transform: `translate(${props.margin.left * 0.3}, ${props.margin.top + 5})` },
                    h("text", { transform: 'translate(0, 20)', height: '5', onClick: () => this.handleChangeYDomain('topdown') }, "-"),
                    h("text", { onClick: () => this.handleChangeYDomain('topup') }, "+")),
            props.axisControl &&
                h("g", { class: axisControl, stroke: props.controlColour, key: 'bottomControl', transform: `translate(${props.margin.left * 0.3}, ${innerHeight})` },
                    h("text", { transform: 'translate(0, 20)', onClick: () => this.handleChangeYDomain('botdown') }, "-"),
            ...
            h("g", { transform: `translate(${props.margin.left}, ${props.margin.top})` },
                ...
                h("path", { d: lineFunc(props.data), "clip-path": `url(#${props.name}_cp)`, strokeLinecap: 'round', stroke: props.lineColour, fill: 'none', "stroke-width": '2px' }),
                (isMouseOver && tooltipValues[0] !== null) &&
                    h("g", { transform: `translate(${this.xScale(tooltipValues[0])},${yScale(tooltipValues[1])})`, key: +tooltipValues[0] },
